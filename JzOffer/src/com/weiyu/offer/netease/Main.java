...
public class Main {
    public static void main(String[] args) {
        ...
        while(in.hasNext()){
            ...
            ArrayList<String> permutations = permutation(line);
            permutations.remove(line);
            System.out.println(permutations);
            int result = getMostMatchingStrs(line,permutations);
            System.out.println(result);
        }
        in.close();
    }

    private static int getMostMatchingStrs(String line, ArrayList<String> permutations) {
        Map<Integer,Integer> map = new HashMap<>();
        for(String permutation : permutations){
            int num = longestCommonSubsequence(line,permutation);
